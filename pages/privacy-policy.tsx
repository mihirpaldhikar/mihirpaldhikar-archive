...
const PrivacyPolicy: NextPage = () => {
  return (
    <div className="container mt-10">
      <h1 className="text-4xl mb-3 font-bold">Privacy Policy</h1>
      <p className="text-sm mb-10">
        Last Updated : 22 September 2022 3:22 AM GMT
      </p>

      <p>
        At mihirpaldhikar.com, accessible from https://mihirpaldhikar.com, one
        of our main priorities is the privacy of our visitors. This Privacy
        Policy document contains types of information that is collected and
        recorded by mihirpaldhikar.com and how we use it.
      </p>
      ...
      <p>
        ...
        shared and/or collect in mihirpaldhikar.com. This policy is not
      ...
      <h2 className="text-2xl font-semibold mb-5 mt-10">Consent</h2>
      ...
      <h2 className="text-2xl font-semibold mb-5 mt-10">Log Files</h2>

      <p>
        mihirpaldhikar.com follows a standard procedure of using log files.
      ...
      <p>
        Like any other website, mihirpaldhikar.com uses &apos;cookies&apos;.
      ...
      <p>
        ...
        advertising partners of mihirpaldhikar.com.
      </p>

      <p>
        Third-party ad servers or ad networks uses technologies like cookies,
        JavaScript, or Web Beacons that are used in their respective
        advertisements and links that appear on mihirpaldhikar.com, which are
      ...
      <p>
        Note that mihirpaldhikar.com has no access to or control over these
      ...
      <p>
        mihirpaldhikar.com&apos;s Privacy Policy does not apply to other
      ...
      <p>
        mihirpaldhikar.com does not knowingly collect any Personal Identifiable
